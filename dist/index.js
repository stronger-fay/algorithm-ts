...
testSorts(array, new sort_1.BubbleSort(), new sort_1.SelectionSort(), new sort_1.HeapSort(), new sort_1.InsertionSort(), new sort_1.MergeSort(), new sort_1.QuickSort(), new sort_1.ShellSort());
